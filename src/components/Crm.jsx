...
function Crm() {
    ...
    const tabs = [
        { name: 'CRM Application', image: '/public/assets/base-render.png' },
        { name: 'E-Commerce Application', image: '/public/assets/base_render-2.png' },
        { name: 'HR Application', image: '/public/assets/base_render (1).png' },
        { name: 'DevOps Dashboard', image: '/public/assets/base_render.png' }
    ];
